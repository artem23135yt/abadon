...
def SetLayout(id,player_symbol): # Устанавливает текст на кнопке с указанным id (1-9) в соответствии с символом текущего игрока.
    if id==1:
...
Button(text="New Game..", font=('Courier new', 24, 'bold'), bg='turquoise', fg='white',
